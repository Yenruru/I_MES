...
(function (angular) {
  ...
  angularCSS.provider('$css', [function $cssProvider() {
    ...
    this.$get = ['$rootScope','$injector','$q','$window','$timeout','$compile','$http','$filter','$log', '$interpolate',
      ...
      var template = '<link ng-repeat="stylesheet in stylesheets | orderBy: \'weight\' track by stylesheet.href " rel="{{ stylesheet.rel }}" type="{{ stylesheet.type }}" ng-href="{{ stylesheet.href }}" ng-attr-media="{{ stylesheet.media }}">';
